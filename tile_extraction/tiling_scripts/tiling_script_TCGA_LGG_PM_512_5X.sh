...
#SBATCH -o ./logs/tile_TCGA_LGG_PM/WSI_tile%A_%a.log                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e ./logs/tile_TCGA_LGG_PM/WSI_tile%A_%a.log                 # File to which STDERR will be written, including job ID (%j)
#SBATCH --array=0-843          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/TCGA_LGG_PM(N=844).csv"
...
PROJ="TCGA_LGG_PM"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
