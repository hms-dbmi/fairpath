...
#SBATCH -o ./logs/tile_PLCO_ovary/WSI_tile%A_%a.log                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e ./logs/tile_PLCO_ovary/WSI_tile%A_%a.log                 # File to which STDERR will be written, including job ID (%j)
#SBATCH --array=0-224          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/PLCO_ovary(N=225).csv"
...
PROJ="PLCO_ovary"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
