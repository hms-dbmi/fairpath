...
#SBATCH --array=0-1192          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/TCGA_GBM_FS(N=1193).csv"
...
PROJ="TCGA_GBM_FS"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
