...
TILE_PARAMS="step1_tile_extraction/tiling_params/tile_params_quick500_w512s512_200.jsonc"        ## tile param file
...
python step1_tile_extraction/WSI_tile_extraction_batch.py \
 ...
 --outpath ${OUTPATH}  --proj ${PROJ} --overwrite_if_exist --output_tiles
