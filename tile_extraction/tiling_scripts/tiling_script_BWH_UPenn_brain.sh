...
#SBATCH -o ./logs/BWH_UPenn_Brain/WSI_tile%A_%a.log                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e ./logs/BWH_UPenn_Brain/WSI_tile%A_%a.log                 # File to which STDERR will be written, including job ID (%j)
#SBATCH --array=0-2990          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/BWH_UPenn_brain(N=2991).csv"
...
PROJ="BWH_UPenn_Brain"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
