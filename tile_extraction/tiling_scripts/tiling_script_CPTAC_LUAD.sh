...
#SBATCH -o ./logs/tile_CPTAC_LUAD/WSI_tile%A_%a.log                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e ./logs/tile_CPTAC_LUAD/WSI_tile%A_%a.log                 # File to which STDERR will be written, including job ID (%j)
#SBATCH --array=0-1136          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="/n/data2/hms/dbmi/kyu/lab/shl968/fairness_external_validation/data_sheet/CPTAC_LUAD(N=1137).csv"
...
PROJ="CPTAC_LUAD"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
