...
#SBATCH --array=0-727          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/TCGA_LGG_FS(N=728).csv"
...
PROJ="TCGA_LGG_FS"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
