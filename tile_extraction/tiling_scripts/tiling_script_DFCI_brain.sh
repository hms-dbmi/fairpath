...
#SBATCH --array=0-1175          # Run array for indexes. Should set to the length of the file list
...
FILE_LIST="data_sheet/DFCI_brain(N=1175).csv"
...
PROJ="DFCI_brain"                ## output subfolder name. the tiles will be stored in [outpath]/[proj]/[slide_name]
